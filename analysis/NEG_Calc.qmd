...
## Step 5: Visualize the Grid (Optional)
...
**This plot shows that the Control group explores the closed arms rapidly and completely, and the open arms to a lesser extent and only after a long delay. Conversely, the Experimental group explores in an arm agnostic manner, indicating lower anxiety.**